...
from tools.executor_tools import get_available_cash, sell_order, buy_order, get_open_positions, list_pending_orders, cancel_orders
...
executor_agent = LlmAgent(
    ...
    instruction="""
        ...
        2- **Create a new trading order:**
            ...
            - **For BUY orders:** Use the 'buy_order' tool. This tool requires prediction data (`prediction_class`, `prediction_probability`) which must be provided by the orchestrator agent.
        ...
        4- **Check available cash:** Use the 'get_available_cash' tool to query the current balance in your account that is available for trading (cash).
